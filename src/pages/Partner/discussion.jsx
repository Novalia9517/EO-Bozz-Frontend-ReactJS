        ...
        <LayoutAdmin>
            ...
            {myDiscussions && myDiscussions.length >= 1 ?
                myDiscussions?.map((item, index) => {
                    return <div className='flex flex-col justify-between my-5' key={index}><div className='h-16 w-full p-3 rounded-lg shadow text-bozz-one border border-bozz-one bg-bozz-six'>
                        <p>{item.comment}</p>
                        </div>
