...
import ServiceAdditional from '../../components/ServiceAdditional'
                                    ...
                                    {listServices.map((data, index) => {
                                        return (
                                            <tr className='text-bozz-three border-b-2 border-bozz-three h-12 text-center py-10' key={index}>
                                                ...
                                                <td><label htmlFor="my-modal-4" className='btn btn-xs border border-white w-14 h-6 bg-bozz-three hover:bg-bozz-two text-bozz-six rounded-lg text-[10px]'>ADD</label></td>
                                                ...
                                                <ServiceAdditional 
                                                    listAdditional={listAdditional} additional={additional}
                                                    chooseAdd={(e) => chooseAdd(setAdditional, e.target.value)}
                                                    onAdd={() => addServiceAdditional(data.id)}
                                                    />
                                            </tr>
                                        )
                                    })}
