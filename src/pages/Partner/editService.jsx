...
//   fieldnya disesuaikan setelah get dari api
  ...
  return (
    <LayoutAdmin>
      <div className='text-bozz-one font-bold flex items-center mt-2'>
        ...
        <div className='px-10 py-3 bg-bozz-seven rounded-[50px] w-[80%] h-full text-bozz-one border border-bozz-one shadow-[6px_6px_6px_rgba(83,62,133,0.5)]'>
          ...
          <div className='flex flex-col justify-between h-full'>
            ...
            <div className='flex justify-between mt-3 bottom-0'>
              ...
              : <button className={`flex items-center justify-center h-8 w-24 text-center bg-bozz-one text-white rounded-lg text-xs`} onClick={() => step == 1 ? setStep(2) : ''}>Edit Service</button>
              }
            </div>
          </div>
        </div>
