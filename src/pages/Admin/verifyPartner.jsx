      ...
      <h1 className='text-center font-bold text-xl text-bozz-one underline underline-offset-4'>Verify Partner</h1>
        ...
        {partnerData ? (
          <ol className='list-decimal marker:text-blue-700 pl-10'>
            ...
            <li><List title={'NIB No'} value={partnerData.nib_number} link={partnerData.nib_image_file} checked={checkboxStatus[8]} onChange={() => buttonHandler(8)} /></li>
            <li><List title={'SIUP No.'} value={partnerData.siup_number} link={partnerData.siup_image_file} checked={checkboxStatus[9]} onChange={() => buttonHandler(9)} /></li>
