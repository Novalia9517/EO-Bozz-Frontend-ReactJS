...
const Detail = () => {
    ...
    const onSubmit = () =>{
        if(values.ask.length >= 10){
            const body = {
                comment : values.ask,
                partner_id : parseInt(detail.partner_id),
                client_id : parseInt(cookie.id),
                service_id : parseInt(detail.id)
            }
    ...
    const getDetail = () => {
        const data = 
            {
                id: 1,
                service_name: "ALL IN INTIMATE WEDDING PACKAGE HOTEL JAKARTA SELATAN 100 PAX",
                service_category: "Wedding",
                service_price: 62437500,
                average_rating: 4.8,
                service_image_file: "",
                ...
                <div className='container px-20 py-20 mx-auto'>
                    <div className='grid gap-10 grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
                        ...
                        <div className='mx-auto text-bozz-one'>
                            <p className='py-3 px-3 font-bold text-xl'>{detail.service_name}</p>
                            <p className='py-3 px-3 font-bold text-xl text-bozz-two'>{formatCurrency(detail.service_price)}</p>
                            <p className=' px-3 text-lg text-[#726F6F]'>Category {detail.service_category}</p>
                            <p className=' px-3 text-lg text-[#726F6F] flex'><AiFillStar className='text-2xl text-orange-300'/> {detail.average_rating} Ratings</p>
                            <div>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-2'>
                            <div className='px-2'>
                                <div className='flex'>
                                    ...
                                    <p className='px-4 text-2xl font-semibold'>Username<br /><span className='text-[#726F6F] text-lg'>12-12-2021</span></p>
                                </div>
